...
DROP TRIGGER TRI_reply_rno_number;
...
DROP SEQUENCE SEQ_reply_rno_number;
...
CREATE SEQUENCE SEQ_reply_rno_number INCREMENT BY 1 START WITH 1;
...
CREATE TABLE reply
(
	rno_number number(10,0) NOT NULL,
	relpy_con varchar2(500) NOT NULL,
	replydate date DEFAULT SYSDATE,
	bno number(10,0) NOT NULL,
	writer varchar2(30) NOT NULL,
	PRIMARY KEY (rno_number)
);
...
CREATE OR REPLACE TRIGGER TRI_reply_rno_number BEFORE INSERT ON reply
FOR EACH ROW
BEGIN
	SELECT SEQ_reply_rno_number.nextval
	INTO :new.rno_number
	FROM dual;
END;
